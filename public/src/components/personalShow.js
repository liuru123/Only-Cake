        ...
        return(
            <div>
                <div className="text-center exclusive">
                    ...
                    <p>
                        <img src="image/ppp/2.jpg" style={{width:'500px',height:'300px'}}/>
                    </p>
                    <p>
                        <div id="exclusive_01" className="exclusive_img_style">
                            <img src="image/ppp/3.png" className="exclusive_img_size gallery-left two"/>
                        </div>
                        <div id="exclusive_02" className="exclusive_img_style">
                            <img src="image/ppp/5.jpg" className="exclusive_img_size gallery-left two"/>
                        </div>
                        <div id="exclusive_04" className="exclusive_img_style">
                            <img src="image/ppp/7.jpg" className="exclusive_img_size gallery-left two"/>
                        </div>
                        <div id="exclusive_03" className="exclusive_img_style">
                            <img src="image/ppp/8.jpg" className="exclusive_img_size gallery-left two"/>
                        </div>
                    </p>
                </div>
            </div>
